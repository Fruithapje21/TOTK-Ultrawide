...
mkdir temp 
mkdir "Result\0100F2C0115B6000\TOTK-Ultrawide\romfs\UI\LayoutArchive"
mkdir "Result\0100F2C0115B6000\TOTK-Ultrawide\exefs"

echo Creating exefs patches
bin\pchtxtCreator.exe "%cd%\Result\0100F2C0115B6000\TOTK-Ultrawide\exefs" %aspect%
...
bin\ZSTD-Tool-1.0.1.exe c "%cd%\temp\%filename1%.blarc" -o "%cd%\Result\0100F2C0115B6000\TOTK-Ultrawide\romfs\UI\LayoutArchive\%filename1%.blarc.zs"
bin\ZSTD-Tool-1.0.1.exe c "%cd%\temp\%filename2%.blarc" -o "%cd%\Result\0100F2C0115B6000\TOTK-Ultrawide\romfs\UI\LayoutArchive\%filename2%.blarc.zs"
